...
- Task:
  ...
  - [X] Recreate a HTML , bootstrap boilerplate and remove unwanted code
  - [X] Show date and day on home page
  - [X] Company name should be visible on home page
  - [X] Show list of total Employee on home page
  - [X] Create a Admin panel
  - [X] Give various rights to admin 
  - [X] Work on UI
